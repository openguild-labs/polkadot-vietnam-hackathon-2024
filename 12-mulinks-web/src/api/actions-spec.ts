export type APTOS_ACTIONS_PROTOCOL = "aptos-action:";

/**
 * @internal
 * Protocol identifier for the aptos Pay protocol
 */
export type APTOS_PAY_PROTOCOL = "aptos:";

/** @internal */
export type SupportedProtocols = APTOS_ACTIONS_PROTOCOL | APTOS_PAY_PROTOCOL;

/**
 * The `actions.json` instruct clients on what website URLs support
 * Aptos Actions and provide the mapping rules for blink urls to reach their Actions API.
 */
