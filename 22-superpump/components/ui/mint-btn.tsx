...
const MintButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-neutral-500 bg-black px-4 py-2 font-mono font-medium uppercase text-secondary transition-colors hover:text-secondary"
    >
